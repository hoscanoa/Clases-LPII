 ...
 */
@WebServlet("/ConsultarJugueteServletV2")
public class ConsultarJugueteServletV2 extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
		...
		request.getRequestDispatcher("consultarV2.jsp").forward(request,
				response);
